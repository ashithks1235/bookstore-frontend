...
import { FaBook, FaPeopleGroup, FaUsers } from 'react-icons/fa6'
      ...
      <div className="col-span-4 p-10">
        <div className="md:grid grid-cols-3">
          <div className="md:px-5 my-5 md:my-0">
            {/* card 1 */}
            <div className="bg-orange-200 p-4 items-center flex text-5xl rounded">
              <FaBook/>
          ...
          <div className="md:px-5 my-5 md:my-0">
            {/* card 1 */}
            <div className="bg-red-200 p-4 items-center flex text-5xl rounded">
              <FaUsers/>
              <div className="text-center ms-10 md:ms-0">
          ...
          <div className="md:px-5 my-5 md:my-0">
            {/* card 1 */}
            <div className="bg-yellow-200 p-4 items-center flex text-5xl rounded">
              <FaPeopleGroup/>
              <div className="text-center ms-10 md:ms-0">
        ...
        {/* charts title */}
      <div className="md:grid grid-cols-2 -5 mt-10 text-lg">
        <div>
